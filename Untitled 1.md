...
• Maschinenkosten: Kosten für Anschaffung, Abschreibung und Betrieb der Fertigungsanlagen.
• Lohnkosten: Personalkosten für die Bedienung und Überwachung der Prozesse.
• Vormaterialkosten: Kosten für die eingesetzten Rohstoffe und Halbzeuge.
• Werkzeugkosten: Kosten für Verschleiß und Austausch von Werkzeugen.
• Energiekosten: Kosten für den Energieverbrauch der Maschinen und Anlagen.
Die Auswahl eines geeigneten Fertigungsverfahrens erfordert eine systematische Bewertung anhand verschiedener Kriterien, die sich in vier Hauptbereiche gliedern lassen:
Produktbezogen
Verfahrensbezogen
Wirtschaftlich
Umwelt/Soziales
...
Die Kostenvergleichsrechnung analysiert die Gesamtkosten verschiedener Verfahren in Abhängigkeit von der produzierten Stückzahl. Dabei wird zwischen Fixkosten (z. B. Abschreibung der Maschine), die unabhängig von der Produktionsmenge anfallen, und variablen Kosten (z. B. Material, Lohn), die direkt mit der Stückzahl steigen, unterschieden.
Die Rentabilitätsrechnung setzt den erzielten Gewinn ins Verhältnis zum eingesetzten Kapital, um die Verzinsung der Investition zu bewerten.
• Formel: R [%] = (Gewinn / Kapitaleinsatz) * 100
...
1. Urformen: Schaffen eines festen Körpers aus formlosem Stoff.
2. Umformen: Ändern der Form eines festen Körpers durch plastische Verformung.
3. Trennen: Ändern der Form durch lokales Aufheben des Stoffzusammenhalts.
4. Fügen: Verbinden von zwei oder mehr Werkstücken.
5. Beschichten: Aufbringen einer festhaftenden Schicht auf ein Werkstück.
...
Ein zentrales Werkzeug zur Umsetzung ist der PDCA-Zyklus (Plan-Do-Check-Act), auch Deming-Kreis genannt, der einen kontinuierlichen Verbesserungsprozess ermöglicht:
1. Plan (Planen): Ein Problem wird analysiert und Maßnahmen zur Verbesserung werden definiert und geplant.
2. Do (Durchführen): Die geplanten Maßnahmen werden in einem begrenzten Rahmen umgesetzt und getestet.
3. Check (Überprüfen): Die Ergebnisse werden gemessen und mit den zuvor definierten Zielen verglichen, um die Wirksamkeit der Maßnahmen zu bewerten.
...
Zur Messung der Oberflächenfeingestalt werden unter anderem zwei Methoden unterschieden:
• Tastschnittgerät: Erfasst die Rauheit linienhaft durch das mechanische Abtasten der Oberfläche mit einer feinen Nadel.
• Optisches Rauheitsmessgerät: Ermöglicht eine flächige, berührungslose Auswertung der Oberflächentopografie.
Jede Messung unterliegt jedoch potenziellen Abweichungen. Zu den wesentlichen Ursachen für Messunsicherheit zählen:
• Unvollständige Definition der Messgröße
• Zu kleine Stichprobe
• Nicht repräsentative Probenentnahme
• Einfluss von Umwelteinflüssen (z. B. Temperatur)
...
• Innerhalb von ±1σ (eine Standardabweichung) vom Mittelwert liegen ca. 68 % aller Messwerte.
• Innerhalb von ±3σ liegen bereits ca. 99,7 % aller Messwerte.
Zwei zentrale Begriffe beschreiben den Zustand eines Prozesses:
• Fähigkeit: Ein Prozess ist fähig, wenn seine Streuung (die Breite der Glockenkurve) deutlich kleiner ist als das vorgegebene Toleranzfeld.
...
Zur Priorisierung der Risiken wird die Risikoprioritätszahl (RPZ) berechnet: RPZ = A * B * E
• A: Auftretenswahrscheinlichkeit des Fehlers
• B: Bedeutung der Fehlerfolge für den Kunden
• E: Entdeckungswahrscheinlichkeit des Fehlers vor Auslieferung
Die Höhe der RPZ bestimmt die Dringlichkeit von Gegenmaßnahmen:
• RPZ < 40: Keine Maßnahmen erforderlich.
• 40 ≤ RPZ ≤ 100: Maßnahmen sind notwendig.
...
Verfahren
Merkmale/Vorteile
Typische Anwendung/Werkstoffe
Kokillenguss
Gießen in metallische Dauerformen (Kokillen). Führt zu feinkörnigem, dichtem Gefüge und guter Oberflächengüte. Hohe Maßgenauigkeit.
Armaturen (dichtes Gefüge), Bauteile aus Al-, Zn-, Cu-, Mg-Legierungen.
Druckguss
Schmelze wird unter hohem Druck in die Form gepresst (Kalt- oder Warmkammerverfahren). Produziert endkonturnahe Bauteile, die nur minimale oder keine nachfolgende Zerspanung erfordern. Sehr rationell für Massenfertigung.
Gehäuse, komplexe Bauteile aus Al-, Mg-, Zn-Legierungen.
Schleuderguss
Die Schmelze wird in eine rotierende Form gegossen. Durch die Zentrifugalkraft entsteht ein dichter, lunkerfreier Hohlkörper mit sauberer Außenfläche.
Rotationssymmetrische Hohlkörper wie Rohre, Buchsen, Zylinderlaufbuchsen.
Feinguss
Nutzt ein verlorenes Modell aus Wachs, das mit Keramik ummantelt wird. Das Wachs wird ausgeschmolzen, die Schmelze eingegossen und die Keramikform nach dem Erstarren zerstört. Ermöglicht sehr präzise, gratfreie Werkstücke ohne Nacharbeit.
Komplexe Bauteile wie Turboladerräder, für alle gießbaren Werkstoffe geeignet.
Vollformguss
Verwendet ein Modell aus Polystyrol-Schaum, das im Formsand verbleibt und beim Gießen vergast. Erlaubt komplexe Konturen ohne Formteilung und Entformungsschrägen.
Prototypen und Einzelstücke, da die Modellherstellung kostengünstig ist.
Gestaltungsregeln für Gussteile
Um Gussfehler zu vermeiden und eine hohe Bauteilqualität zu erreichen, müssen spezifische Gestaltungsregeln beachtet werden:
• Vermeidung von Lunkern: Materialanhäufungen sind zu vermeiden. Um das Schwindungsvolumen beim Erstarren auszugleichen, werden Speiser eingesetzt, die flüssiges Metall nachliefern.
...
Prozessbeschreibung
Der Sinterprozess umfasst die folgenden sechs Arbeitsschritte:
1. Herstellung der Pulver: Erzeugung feiner Partikel (z. B. durch Wasserverdüsen).
2. Aufbereitung der Pulver: Mischen der Pulver, ggf. Zugabe von Gleitmitteln.
3. Pressen der Grünkörper: Das Pulver wird in einer Form zu einem festen, aber noch porösen „Grünling“ gepresst.
4. Sintern: Der Grünkörper wird unterhalb der Schmelztemperatur des Hauptbestandteils erhitzt. Die Partikel verbinden sich durch Diffusionsvorgänge.
5. Kalibrieren (ggf.): Nachpressen zur Erhöhung der Maßgenauigkeit.
6. Nachbehandeln (ggf.): Z. B. Tränken mit Öl für selbstschmierende Lager.
Vorteile und Werkstoffe
Das Sintern bietet mehrere Vorteile:
• Rohstoffsparend und energiesparend (near-net-shape).
• Herstellung von porösen Körpern (z. B. Filter, selbstschmierende Lager).
• Ermöglicht Legierungen, die schmelzmetallurgisch nicht herstellbar sind.
...
• Druckumformen: Walzen, Schmieden, Fließpressen
• Zugumformen: Längen, Weiten, Tiefen
• Zug-Druckumformen: Tiefziehen, Drücken, Kragenziehen
...
Beim Zerspanen dringt ein keilförmiges Werkzeug (die Schneide) in den Werkstoff ein und trennt eine Schicht in Form eines Spans ab. Die Geometrie an der Schneide, insbesondere der Spanwinkel (γ), beeinflusst die Spanbildung maßgeblich. Der Werkstoff wird in einer engen Zone, der Scherebene, plastisch verformt, was durch den Scherwinkel (ϕ) beschrieben wird. Je nach Werkstoff und Schnittbedingungen entstehen unterschiedliche Spanarten, wie z.B. der Lamellenspan.
Werkzeugverschleiß und Standzeit
Die hohen mechanischen und thermischen Belastungen führen zu Verschleiß am Werkzeug. Die Standzeit – die Zeit, in der ein Werkzeug qualitativ einwandfrei arbeitet – wird von mehreren Parametern beeinflusst, wobei die Schnittgeschwindigkeit den signifikantesten, exponentiellen Einfluss hat. Erhöhungen von Vorschub und Schnitttiefe reduzieren die Standzeit ebenfalls, jedoch in geringerem Maße.
Schneidwerkstoffe
...
• Fräsen: Ein rotierendes Werkzeug mit mehreren Schneiden bearbeitet ein feststehendes Werkstück. Man unterscheidet Stirnfräsen und Umfangsfräsen. Zudem wird zwischen Gegenlauffräsen und Gleichlauffräsen differenziert. Beim Gegenlauffräsen bewegt sich die Schneide entgegen der Vorschubrichtung, was zu einem Span führt, der von dünn nach dick anwächst. Beim Gleichlauffräsen bewegen sich Schneide und Vorschub in die gleiche Richtung, was einen Span von dick nach dünn erzeugt und oft zu besseren Oberflächen und längeren Standzeiten führt. Das Hochgeschwindigkeitsfrä