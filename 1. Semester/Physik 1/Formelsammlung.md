...
- **Beschleunigungsarbeit** (Änderung der Bewegungsenergie): `W_B = ½ ∙ m ∙ v_end² - ½ ∙ m ∙ v_anf²`
- **Elastische Verformungsarbeit (Spannarbeit)** (Dehnung/Stauchung einer Feder): `W_E = ½ ∙ D ∙ s²` (aus der Ruhelage)
...
- **Gesamte kinetische Energie (Rollbewegung):** `W_kin = W_kin,tr + W_kin,rot = ½ ∙ m ∙ v² + ½ ∙ J ∙ ω²`
